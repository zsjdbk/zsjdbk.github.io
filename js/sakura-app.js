...
function nextBG() {
    $(".centerbg").css("background-image", 'url("https://cdn.jsdelivr.net/gh/zsjdbk/cnd@1.1/(' + Math.abs(bgn%5) + ').webp")');
    bgn = bgn + 1;
}
...
$(document).ready(function () {
    $(".centerbg").css("background-image", 'url("https://cdn.jsdelivr.net/gh/zsjdbk/cnd@1.1/(' + bgn + ').webp")');
